...
const top = [
    ...
    {
        logo: "https://cdn.moning.co/logos/OKB-USD.CC.png",
        name: "OKB",
        ticker: "okb",
    ...
    {
        logo: "https://cdn.moning.co/logos/LDO-USD.CC.png",
        name: "Lido DAO",
        ticker: "lido-dao",
...
const flop = [
    {
        logo: "https://cdn.moning.co/logos/HEX-USD.CC.png",
        name: "HEX",
        ticker: "hex",
...
const heading = {
    ...
    paragraph: "Restez à l'affût de ce qui bouge en ce moment et les cryptos les plus détenues par les investisseurs sur Invvest."
};
                            ...
                            {notTrendingByPopular ?
                                <>
                                    ...
                                    <div className="w-full flex lg:flex-[10]">
                                        ...
                                        <div className="hidden lg:block text-center flex-[3]">Capitalisation</div>
                                ...
                                <div className="flex items-center gap-2" style={{ width: "314px" }}>
                                    ...
                                    <div className="flex flex-col items-start justify-between gap-2">
                                        <div className="flex gap-2 items-center text-gray-300 text-sm">
                                            <span className="uppercase">{stock.ticker}</span>
                                        </div>
