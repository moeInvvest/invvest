...
function CryptoChart({ crypto }) {
    ...
    useEffect(() => {
        const chartDataRes = crypto.historical;
            ...
            datasets: [
                {
                    ...
                    backgroundColor: (context) => {
                        ...
                        gradient.addColorStop(0, chartDataRes[0].price < crypto.price ? "rgba(6, 196, 47, 0.3)" : "rgba(255, 0, 0, 0.3)");
                        gradient.addColorStop(1, chartDataRes[0].price < crypto.price ? "rgba(6, 196, 47, 0.01)" : "rgba(255, 0, 0, 0.01)");
                        return gradient;
                    },
                    borderColor: chartDataRes[0].price < crypto.price ? "#06c42f" : "red",
                    borderWidth: 2,
                    fill: true,
                    pointRadius: 0,
                    tension: 0.3,
